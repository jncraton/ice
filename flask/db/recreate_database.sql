...
-- ALTER TABLE student_submission ADD FOREIGN KEY (fk_exercise_id) REFERENCES exercise (pk_exercise);

-- ALTER TABLE student_submission ADD FOREIGN KEY (fk_student_id) REFERENCES student (pk_student_id);

-- ALTER TABLE exercise ADD FOREIGN KEY (fk_section) REFERENCES section (pk_section_id);

-- ALTER TABLE student ADD FOREIGN KEY (fk_section_id) REFERENCES section (pk_section_id);
